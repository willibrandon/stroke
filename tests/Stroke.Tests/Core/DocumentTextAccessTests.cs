...
/// <summary>
/// Tests for Document text access properties (User Story 1).
/// Covers character access, text splitting, line properties, and cursor position translation.
/// </summary>
public class DocumentTextAccessTests
{
