...
/// <summary>
/// Margins example — demonstrates NumberedMargin and ScrollbarMargin.
/// Port of Python Prompt Toolkit's margins.py example.
/// </summary>
internal static class Margins
{
    private static readonly string Lipsum = string.Concat(Enumerable.Repeat(
        ...
        try
        {
            ...
            [
                ...
                new Window(
                    ...
                    leftMargins: [new NumberedMargin(), new ScrollbarMargin()],
                    rightMargins: [new ScrollbarMargin(), new ScrollbarMargin()]),
            ]);
