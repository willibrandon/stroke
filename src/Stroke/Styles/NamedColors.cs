...
public static class NamedColors
{
    ...
    /// </summary>
    /// <remarks>
    /// Keys are PascalCase as in the CSS specification. Values are lowercase
    /// 6-digit hex codes without the # prefix.
    ...
    /// <summary>
    /// Lowercase lookup dictionary for case-insensitive color matching.
    /// </summary>
    private static readonly FrozenDictionary<string, string> _lowercaseLookup =
        Colors.ToFrozenDictionary(
    ...
    {
        return _lowercaseLookup.TryGetValue(name.ToLowerInvariant(), out hexValue!);
    }
}
