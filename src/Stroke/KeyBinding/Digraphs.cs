...
{
    private static readonly FrozenDictionary<(char Char1, char Char2), int> _map = CreateDigraphDictionary();
    ...
    /// </code>
    /// </example>
    public static IReadOnlyDictionary<(char Char1, char Char2), int> Map => _map;
    ...
    /// Greek lowercase alpha, while <c>('A', '*')</c> maps to uppercase Alpha.
    /// </para>
    /// <para>
    ...
    {
        return _map.TryGetValue((char1, char2), out var codePoint) ? codePoint : null;
    }
    ...
    private static FrozenDictionary<(char Char1, char Char2), int> CreateDigraphDictionary()
    {
        // Digraphs for Unicode from RFC1345
        // (also work for ISO-8859-1 aka latin1)
        // Ported from Python Prompt Toolkit's prompt_toolkit/key_binding/digraphs.py
        // which was taken from Neovim's digraph.c
        var dict = new Dictionary<(char, char), int>
        {
            ...
            // Enclosed CJK Letters and Months (0x3220-0x3229)
            [('1', 'c')] = 0x3220,
            [('2', 'c')] = 0x3221,
            [('3', 'c')] = 0x3222,
            [('4', 'c')] = 0x3223,
            ...
            // Latin ligatures and remaining (0xFB00-0xFB06)
            [('f', 'f')] = 0xFB00,
            [('f', 'i')] = 0xFB01,
            [('f', 'l')] = 0xFB02,
            [('f', 't')] = 0xFB05,
